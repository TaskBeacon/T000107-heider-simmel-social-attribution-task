...
T000107 与 H000107 均标注为中文行为任务。浏览器版本可用于流程体验和一般行为采集，但设备、键盘及浏览器环境与本地 PsychoPy 采集不同，不应视为 EEG、MRI 或临床采集版本的等价替代。
...
![TaskBeacon Heider–Simmel 社会归因任务流程](../task_flow.png)
